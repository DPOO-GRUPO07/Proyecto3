...
import interfaz.DatosVentasAnuales;

public class VentanaGraficoVentas extends JPanel implements ActionListener {
    private DatosVentasAnuales datos;
    private static final String[] DIAS = {"L", "M", "M", "J", "V", "S", "D"};

    public VentanaGraficoVentas(DatosVentasAnuales datos) {
        this.datos = datos;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString("Gráfico Ventas Piezas 2023", getWidth() / 4, 20);
    ...
    public void mostrarVentana() {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Gráfico Ventas Piezas 2023");
